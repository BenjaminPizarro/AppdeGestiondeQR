...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnViewMapQuick = findViewById(R.id.btn_view_map_quick); // Nuevo botón
        ...
        // Acción para el nuevo botón de mapa
        btnViewMapQuick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, MapDisplayActivity.class);
                // No pasamos un ID de activo aquí, ya que no hay uno seleccionado.
                // La MapDisplayActivity ya maneja este caso.
                startActivity(intent);
            }
        });
